...
Total_Trans_Ct_int = Total_Trans_Ct_int/10

#simple_bar = barplot.SimpleBarChart('Customer_Age', 'Credit_Limit', 'Credit Limit and Customer Age bar')
#simple_bar.bar(Customer_Age_int, Total_Trans_Ct_int, Dependent_count_int)
