...
from TwoDimensional_Plotting import StackPlot as Stack_Plot
...
stack_plot = Stack_Plot.StackPlot(arr, stock_pie_labels)
stack_plot.add()
# stack_plot.show()
...
#                               Total_Relationship_Count_int, Months_Inactive_12_mon_int, Total_Trans_Ct_int,
#                               stock_pie_labels)
